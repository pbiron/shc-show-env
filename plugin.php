 ...
 */
function shc_show_env_add_node() {
	/**
...
function shc_show_env_id_env() {
	 ...
	 *     @type string $1 The class of the env.  One of 'prod', 'staging', 'dev', or a custom class.
	 *     }
	 *
	 * @return array Environment name in index 0 and environment class in index 1
	 */
